...
public class ScheduleTaskConfigration {
	 ...
	 */
	@Bean(name = "jobDetail")
	public MethodInvokingJobDetailFactoryBean detailFactoryBean(UpdateGraphDirctory task) {// ScheduleTask为需要执行的任务
		...
		jobDetail.setName("updateGraphDirctory");// 设置任务的名字
		 ...
		 */
		jobDetail.setTargetMethod("updateGraphDirctory");
		return jobDetail;
	}
