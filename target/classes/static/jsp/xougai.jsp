...
<html>
	...
	<script type="text/javascript">
		...
		function tijiao(name,name2) {
			...
			if(num>1&&num<11){
				...
				alert(mz);
				location.href="monitor/Xougai.do?id="+id+"&name="+name+"&mz="+mz+"&name2="+name2;
			}else{
				var a = num<=1?"请至少选择两位数！":"你选择了"+num+"位，请选择小于10位数！"
				alert(a)
  ...
  <body style="background-color:#8aade9; ">
    <div align="center" >
    	...
    	<h4>名称：</h><input id = "mz" value="${name3}"><br>
    	<button onclick="tijiao('${name}','${name2}');">提交</button>
    </div>
